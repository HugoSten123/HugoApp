 ...
 */
const ajPalettes = {
    brand: generatePalette('#ffd500'),
    brandRed: generatePalette('#e63027')
};
const cowabPalettes = {
    cowab: generatePalette('#007bff')
};
...
const themes = {
    ...
    aj: {
        primary: {
            ...ajPalettes.brandRed,
            DEFAULT: ajPalettes.brandRed[500]
        },
        accent: {
            ...ajPalettes.brand,
            DEFAULT: ajPalettes.brand[550]
        }
    },
    cowab: {
        primary: {
            ...cowabPalettes.cowab,
            DEFAULT: cowabPalettes.cowab[500]
        },
        accent: {
            ...cowabPalettes.cowab,
            DEFAULT: cowabPalettes.cowab[500]
